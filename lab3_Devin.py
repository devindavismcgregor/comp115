...
def draw_regular_polygon(num_sides, side_length):
    ...
    for _ in range(6):
        pen.forward(10)
        pen.right(60)# Complete the function body
    pen.shape("blank")
    pen.clear()
...
def draw_rectangle(length, width):
    ...
    for _ in range(2):
        ...
        pen.right(90)
        pen.forward(10)
        pen.right(90) # Complete the function body
    pen.shape("blank")
    pen.clear()
...
def draw_circles(num_circles):
    ...
    for _ in range(1):
        ...
        pen.circle(20)
        pen.circle(25)
        pen.circle(30) # Complete the function body
    pen.shape("blank")
    pen.clear()
...
def draw_concentric_circles(num_circles):
    ...
    for _ in range(num_circles):
        pen.circle(10) # Complete the function body
    pen.shape("blank")
    pen.clear()
