...
Your Name 😍:Devin Davis-McGregor
...
# The following code is to print all the even numbers less than or equal to 10.
x = 0
while x < 10: # to see if x is less than 10
    x = x + 2
    print(x)
...
my_name = "Devin" # Change to your name
my_github_account = "https://github.com/devindavismcgregor" # Change to your GitHub account
my_hobby = "Playing Guitar" # Change to your hobby
